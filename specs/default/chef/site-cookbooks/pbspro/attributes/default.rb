...
default[:pbspro][:hostname_update_script_path] = "/opt/cycle/hostname/update_hostname.py"
default[:pbspro][:hostname_remove_script_path] = "/opt/cycle/hostname/remove_hostname.py
