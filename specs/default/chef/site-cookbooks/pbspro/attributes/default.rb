...
default[:hostname_update][:hostname_update_script_path] = "/opt/cycle/hostname/update_hostname.py"
default[:hostname_update][:hostname_remove_script_path] = "/opt/cycle/hostname/remove_hostname.py"
default[:hostname_update][:environment_path] = "/opt/cycle/hostname"
default[:hostname_update][:handler_path] = "/tmp/update_hostname_handler.py"
